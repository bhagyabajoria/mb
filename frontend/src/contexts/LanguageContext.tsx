...
const translations = {
  en: {
    ...
    "home.features.secureStorage": "Secure Cloud Storage",
    "home.features.docVerification": "Document Verification",
    "home.features.instantShare": "Instant Sharing",
    "home.features.mobileAccess": "Mobile Access",
    "home.security.sslSecured": "SSL Secured",
    "home.security.iso27001": "ISO 27001",
    "home.security.hipaaCompliant": "HIPAA Compliant",
    ...
    "verification.progress.title": "Verification Progress",
    "verification.progress.subtitle":
      "Track your health record verification status",
    "verification.progress.overall": "Overall Verification",
    "verification.progress.verified": "Verified",
    "verification.progress.pending": "Pending",
    "verification.progress.total": "Total",
    "verification.verify": "Verify",
    "verification.success": "Record verified successfully",
    ...
    "records.filterByType": "Filter by type",
    "records.allTypes": "All Types",
    "records.export": "Export",
    "records.noMatchingRecords": "No matching records",
    "records.noRecordsYet": "No health records yet",
    "records.adjustSearch": "Try adjusting your search or filter criteria",
    "records.startAdding": "Start by adding your first health record",
    "records.addFirstRecord": "Add Your First Record",
    "records.addSample": "Add Sample Record",
    "records.addSampleShort": "Sample",
    "records.exportExcel": "Export to Excel",
    "records.exportShort": "Export",
    "records.addNewShort": "Add",
    "records.types.consultation": "Consultation",
    "records.types.labResult": "Lab Result",
    "records.types.prescription": "Prescription",
    "records.types.imaging": "Imaging",
    "records.types.surgery": "Surgery",
    "records.types.vaccination": "Vaccination",
    "records.types.emergency": "Emergency",
    "records.types.followUp": "Follow Up",
    "records.types.other": "Other",
  ...
  hi: {
    ...
    "home.features.secureStorage": "सुरक्षित क्लाउड स्टोरेज",
    "home.features.docVerification": "दस्तावेज़ सत्यापन",
    "home.features.instantShare": "तत्काल साझाकरण",
    "home.features.mobileAccess": "मोबाइल एक्सेस",
    "home.security.sslSecured": "SSL सुरक्षित",
    "home.security.iso27001": "ISO 27001",
    "home.security.hipaaCompliant": "HIPAA अनुपालित",
    ...
    // Verification Progress
    "verification.progress.title": "सत्यापन प्रगति",
    "verification.progress.subtitle":
      "अपने स्वास्थ्य रिकॉर्ड की सत्यापन स्थिति ट्रैक करें",
    "verification.progress.overall": "समग्र सत्यापन",
    "verification.progress.verified": "सत्यापित",
    "verification.progress.pending": "लंबित",
    "verification.progress.total": "कुल",
    "verification.verify": "सत्यापित करें",
    "verification.success": "रिकॉर्ड सफलतापूर्वक सत्यापित किया गया",
    "verification.error": "सत्यापन विफल हो गया",
    ...
    "records.filterByType": "प्रकार के अनुसार फ़िल्टर करें",
    "records.allTypes": "सभी प्रकार",
    "records.export": "निर्यात",
    "records.noMatchingRecords": "कोई मेल खाता रिकॉर्ड नहीं",
    "records.noRecordsYet": "अभी तक कोई स्वास्थ्य रिकॉर्ड नहीं",
    "records.adjustSearch":
      "अपने खोज या फ़िल्टर मापदंड को समायोजित करने की कोशिश करें",
    "records.startAdding": "अपना पहला स्वास्थ्य रिकॉर्ड जोड़कर शुरू करें",
    "records.addFirstRecord": "अपना पहला रिकॉर्ड जोड़ें",
    "records.addSample": "नमूना रिकॉर्ड जोड़ें",
    "records.addSampleShort": "नमूना",
    "records.exportExcel": "एक्सेल में निर्यात करें",
    "records.exportShort": "निर्यात",
    "records.addNewShort": "जोड़ें",
    "records.types.consultation": "परामर्श",
    "records.types.labResult": "लैब परिणाम",
    "records.types.prescription": "नुस्खा",
    "records.types.imaging": "इमेजिंग",
    "records.types.surgery": "शल्य चिकित्सा",
    "records.types.vaccination": "टीकाकरण",
    "records.types.emergency": "आपातकाल",
    "records.types.followUp": "फॉलो अप",
    "records.types.other": "अन्य",
