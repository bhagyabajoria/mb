...
const ICD11Example: React.FC = () => {
  const [selectedDisease, setSelectedDisease] = useState<ISelectedEntity | null>(null);
          ...
          {selectedDisease && (
            <Card className="border-green-200 bg-green-50">
              <CardContent className="pt-4">
                <h3 className="font-semibold text-lg mb-2">Selected Disease Information:</h3>
                <div className="space-y-2">
                  ...
                  {selectedDisease.selectedText && (
                    <p className="text-sm text-gray-600">
                      <strong>Search term:</strong> {selectedDisease.selectedText}
                    </p>
                  )}
                  <p className="text-sm text-gray-600">
                    <strong>Foundation URI:</strong> {selectedDisease.foundationUri}
                  </p>
                  <p className="text-sm text-gray-600">
                    <strong>Linearization URI:</strong> {selectedDisease.linearizationUri}
                  </p>
                </div>
              </CardContent>
            </Card>
